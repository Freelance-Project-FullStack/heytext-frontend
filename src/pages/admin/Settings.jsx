...
const Settings = () => {
  ...
  // Form states
  const [paymentForm, setPaymentForm] = useState(settings.payment.banking);
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        setEmailForm(settings.emailSettings);
      } catch (error) {
        setSnackbar({
          open: true,
            ...
            <form onSubmit={handlePaymentSubmit}>
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  ...
                  <Divider sx={{ mb: 2 }} />
                  <Typography variant="h6" gutterBottom>
                    <Link href="https://api.vietqr.io/v2/banks">Danh sách Ngân hàng</Link>
                  </Typography>
                  <Divider sx={{ mb: 2 }} />
                </Grid>
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    helperText="Ví dụ: PREMIUM_ hoặc COURSE_"
                    value={paymentForm.transferPrefix}
                    onChange={(e) => setPaymentForm({ ...paymentForm, transferPrefix: e.target.value })}
                    required
                  />
                </Grid>
